...
const dbf = class DBFunctions{
     ...
     * @param {string} tconst string - Primary key of the title table
...
DELETE FROM title
     ...
     * @param {string[]} titleType string[] - Types of media
     ...
     * @param {string[]} genres string[] - Genres of the media (i.e. romance, drama, action...)
     ...
     */
    searchTitle(title=null, titleTypes=null, isAdult=null, minYear=null, maxYear=null, minRunTimeMinutes=null, maxRunTimeMinutes=null, minRating=null, maxRating=null, genres=null, page=1, itemsPerPage=50) {
